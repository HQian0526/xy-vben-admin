    ...
    <div class="content">
      ...
      <div id="about" class="about-us">
        <img
          :src="bgSrc1"
          alt="banner"
          style="width: 100%; height: 100%; object-fit: fill; opacity: 0.3"
        />
        <div class="intro-text">
          <h1 style="font-size: 24px; font-weight: bold">关于星萤网络</h1>
          <p style="margin-top: 40px; text-indent: 2em; letter-spacing: 2px">
            广州市星萤网络有限公司是一家专注于智能化解决方案的公司，致力于为客户提供一站式的智能化解决方案，包括智慧物业、智慧家居、智慧小区、智慧小店、无人经济等领域的综合性解决方案。客户满意度超95%，处于行业领先水平。
          </p>
          <p style="margin-top: 40px; text-indent: 2em; letter-spacing: 2px">
